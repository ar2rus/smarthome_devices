...
inline const TimeZoneOption* findTimeZoneById(const char* id) {
  if (!id) return nullptr;
  for (size_t i = 0; i < TIME_ZONES_COUNT; ++i) {
    if (!strcmp(id, TIME_ZONES[i].id)) return &TIME_ZONES[i];
  }
  return nullptr;
}
...
inline const char* getPosixTimeZone(TimeZoneKey key) {
  switch (key) {
    case TZKEY_Europe_Kaliningrad: return TZ_Europe_Kaliningrad;
    case TZKEY_Europe_Moscow: return TZ_Europe_Moscow;
    case TZKEY_Europe_Samara: return TZ_Europe_Samara;
    case TZKEY_Asia_Yekaterinburg: return TZ_Asia_Yekaterinburg;
    case TZKEY_Asia_Omsk: return TZ_Asia_Omsk;
    case TZKEY_Asia_Krasnoyarsk: return TZ_Asia_Krasnoyarsk;
    case TZKEY_Asia_Irkutsk: return TZ_Asia_Irkutsk;
    case TZKEY_Asia_Yakutsk: return TZ_Asia_Yakutsk;
    case TZKEY_Asia_Vladivostok: return TZ_Asia_Vladivostok;
    case TZKEY_Asia_Magadan: return TZ_Asia_Magadan;
    case TZKEY_Asia_Kamchatka: return TZ_Asia_Kamchatka;
    case TZKEY_America_New_York: return TZ_America_New_York;
    case TZKEY_America_Chicago: return TZ_America_Chicago;
    case TZKEY_America_Denver: return TZ_America_Denver;
    case TZKEY_America_Los_Angeles: return TZ_America_Los_Angeles;
    case TZKEY_UTC:
    default: return "UTC0";
  }
}
